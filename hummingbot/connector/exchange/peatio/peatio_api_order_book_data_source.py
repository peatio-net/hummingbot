...
from .peatio_utils import PeatioAPIError, convert_from_exchange_trading_pair, convert_to_exchange_trading_pair
...
class PeatioAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def listen_for_trades(self, ev_loop: asyncio.BaseEventLoop, output: asyncio.Queue):
        ...
        while True:
            try:
                ws = PeatioWebsocket(throttler=self._throttler)
