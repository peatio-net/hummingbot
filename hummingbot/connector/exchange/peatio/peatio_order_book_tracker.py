...
class PeatioOrderBookTracker(OrderBookTracker):
    ...
    def __init__(self,
        ...
        super().__init__(
            data_source=PeatioAPIOrderBookDataSource(trading_pairs=trading_pairs),
        ...
        self._active_order_tracker = PeatioActiveOrderTracker()

    @property
    def exchange_name(self) -> str:
        return f"{Constants.EXCHANGE_NAME}"
